...
vi.mock('../../components/shared/auth-form.module.css', () => ({ unstable_styles: {} }));
vi.mock('../../components/shared/snackbar', () => ({ Snackbar: () => null }));
vi.mock('../../contexts/session-context', () => ({ useSession: () => session }));
