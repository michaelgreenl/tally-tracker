...
import { CounterStorage } from '../../infra/storage/counter-storage';
...
vi.mock('../../infra/widgets/widget-bridge', () => ({
    widgetBridge: {
...
vi.mock('../../services/auth/auth.service', () => ({
    AuthService: { getCachedUser: async () => ({ id: 'account' }) },
}));
vi.mock('../../infra/http/api', () => ({
    default: bridge.fetch,
    ApiError: bridge.ApiError,
