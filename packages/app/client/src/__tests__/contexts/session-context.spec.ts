...
import { changeSession, getSessionScope, writeSession } from '../../services/session/session-scope';
...
vi.mock('../../services/auth/auth.service', () => ({ AuthService: auth }));
vi.mock('../../services/billing/billing.service', () => ({ BillingService: billing, billingApiKey: apiKey }));
