...
import apiFetch, { ApiError } from '../../../infra/http/api';
import { changeSession, SessionChangedError } from '../../../services/session/session-scope';
...
vi.mock('../../../infra/http/api', async (original) => ({
    ...(await original<typeof import('../../../infra/http/api')>()),
    default: vi.fn(),
}));
