...
import apiFetch, { ApiError } from '../http/api';
import { AuthService } from '../../services/auth/auth.service';
import { SyncQueue } from './sync-queue';
import { pendingWidgetTaps } from '../widgets/widget-sync';
import { assertSession, getSessionScope, SessionChangedError } from '../../services/session/session-scope';
import type { SessionScope } from '../../services/session/session-scope';
