...
export const IdempotencyLogScalarFieldEnumSchema = z.enum(['key','userId','requestHash','status','responseStatus','responseBody','createdAt','updatedAt']);
...
export const IdempotencyLogWhereInputSchema: z.ZodType<Prisma.IdempotencyLogWhereInput> = z.strictObject({
  ...
  userId: z.union([ z.lazy(() => UuidFilterSchema), z.string() ]).optional(),
  requestHash: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
  status: z.union([ z.lazy(() => EnumIdempotencyStatusFilterSchema), z.lazy(() => IdempotencyStatusSchema) ]).optional(),
  responseStatus: z.union([ z.lazy(() => IntNullableFilterSchema), z.number() ]).optional().nullable(),
...
.and(z.strictObject({
  ...
  requestHash: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
  status: z.union([ z.lazy(() => EnumIdempotencyStatusFilterSchema), z.lazy(() => IdempotencyStatusSchema) ]).optional(),
  responseStatus: z.union([ z.lazy(() => IntNullableFilterSchema), z.number().int() ]).optional().nullable(),
  responseBody: z.lazy(() => JsonNullableFilterSchema).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
}));
...
export const IdempotencyLogScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.IdempotencyLogScalarWhereWithAggregatesInput> = z.strictObject({
  ...
  userId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema), z.string() ]).optional(),
  requestHash: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema), z.string() ]).optional().nullable(),
  status: z.union([ z.lazy(() => EnumIdempotencyStatusWithAggregatesFilterSchema), z.lazy(() => IdempotencyStatusSchema) ]).optional(),
  responseStatus: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema), z.number() ]).optional().nullable(),
...
export const IdempotencyLogUpdateInputSchema: z.ZodType<Prisma.IdempotencyLogUpdateInput> = z.strictObject({
  ...
  userId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  requestHash: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  status: z.union([ z.lazy(() => IdempotencyStatusSchema), z.lazy(() => EnumIdempotencyStatusFieldUpdateOperationsInputSchema) ]).optional(),
  responseStatus: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  responseBody: z.union([ z.lazy(() => NullableJsonNullValueInputSchema), InputJsonValueSchema ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
});
...
export const EnumIdempotencyStatusFilterSchema: z.ZodType<Prisma.EnumIdempotencyStatusFilter> = z.strictObject({
  ...
  in: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  notIn: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  not: z.union([ z.lazy(() => IdempotencyStatusSchema), z.lazy(() => NestedEnumIdempotencyStatusFilterSchema) ]).optional(),
});
...
export const IdempotencyLogAvgOrderByAggregateInputSchema: z.ZodType<Prisma.IdempotencyLogAvgOrderByAggregateInput> = z.strictObject({
  responseStatus: z.lazy(() => SortOrderSchema).optional(),
});
...
export const IdempotencyLogSumOrderByAggregateInputSchema: z.ZodType<Prisma.IdempotencyLogSumOrderByAggregateInput> = z.strictObject({
  responseStatus: z.lazy(() => SortOrderSchema).optional(),
});

export const EnumIdempotencyStatusWithAggregatesFilterSchema: z.ZodType<Prisma.EnumIdempotencyStatusWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => IdempotencyStatusSchema).optional(),
  in: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  notIn: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  not: z.union([ z.lazy(() => IdempotencyStatusSchema), z.lazy(() => NestedEnumIdempotencyStatusWithAggregatesFilterSchema) ]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
...
export const EnumIdempotencyStatusFieldUpdateOperationsInputSchema: z.ZodType<Prisma.EnumIdempotencyStatusFieldUpdateOperationsInput> = z.strictObject({
...
export const NestedEnumIdempotencyStatusFilterSchema: z.ZodType<Prisma.NestedEnumIdempotencyStatusFilter> = z.strictObject({
  equals: z.lazy(() => IdempotencyStatusSchema).optional(),
  in: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  notIn: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  not: z.union([ z.lazy(() => IdempotencyStatusSchema), z.lazy(() => NestedEnumIdempotencyStatusFilterSchema) ]).optional(),
...
export const NestedEnumIdempotencyStatusWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumIdempotencyStatusWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => IdempotencyStatusSchema).optional(),
  in: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  notIn: z.lazy(() => IdempotencyStatusSchema).array().optional(),
  not: z.union([ z.lazy(() => IdempotencyStatusSchema), z.lazy(() => NestedEnumIdempotencyStatusWithAggregatesFilterSchema) ]).optional(),
